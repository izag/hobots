...
public class StateUtils
{
	...
	/**
	 * Читает значение типа int из словаря. Если в словаре нет указанного
	 * значения, возвращает указанное значение по умолчанию.
	 *
	 * @param dictionary
	 * @param key
	 * @param defaultValue
	...
	/**
	 * Читает значение типа bool из словаря. Если в словаре нет указанного
	 * значения, возвращает указанное значение по умолчанию.
	 *
	 * @param dictionary
	 * @param key
	...
	/**
	 * Вспомогательный интерфейс для описания действий, которые завершаются с
	 * исключениями
	 *
	 */
	...
	/**
	 * Вспомогательный метод для выполнения действий с перехватом и подавлением
	 * исключений
	 *
	 * @param action
	 */
